...
public class UserServiceIT {
    ...
    @Test
    @Transactional
    public void shouldReturnTrueForBothWhenBothAlreadyExists(){
        User user = new User();
        user.setLogin("conflictName");
        user.setEmail("email-conflict@example.com");
        user.setPassword(RandomStringUtils.random(60));

        userRepository.saveAndFlush(user);

        UserDTO userDTO = new UserDTO();
        userDTO.setEmail("email-conflict@example.com");
        userDTO.setLogin("conflictName");

        UsernameEmailValidationRespDto validationRespDto = userService.checkUsernameEmailConflict(userDTO.getLogin(), userDTO.getEmail());

        assertThat(validationRespDto.isEmailExists()).isTrue();
        assertThat(validationRespDto.isUsernameExists()).isTrue();
    }

    @Test
    @Transactional
    public void shouldReturnFalseForBothWhenBothDoesNotAlreadyExists(){
        User user = new User();
        user.setLogin("no-username-conflict");
        user.setEmail("no-email-conflict@example.com");
        user.setPassword(RandomStringUtils.random(60));
        ...
        assertThat(validationRespDto.isEmailExists()).isFalse();
        assertThat(validationRespDto.isUsernameExists()).isFalse();
    }

    @Test
    @Transactional
    public void shouldReturnTrueForEmailWhenEmailAlreadyExists(){
        User user = new User();
        user.setLogin("no-conflict-username");
        user.setEmail("email-conflict-yes@example.com");
        user.setPassword(RandomStringUtils.random(60));

        userRepository.saveAndFlush(user);

        UserDTO userDTO = new UserDTO();
        userDTO.setEmail("email-conflict-yes@example.com");
        userDTO.setLogin("conflictName");
    ...
    @Test
    @Transactional
    public void shouldReturnTrueForUsernameWhenUsernameAlreadyExists(){
        User user = new User();
        user.setLogin("conflictName2");
        user.setEmail("no-conflict@example.com");
        user.setPassword(RandomStringUtils.random(60));
        ...
        UserDTO userDTO = new UserDTO();
        userDTO.setEmail("email-conflict@example.com");
        userDTO.setLogin("conflictName2");
