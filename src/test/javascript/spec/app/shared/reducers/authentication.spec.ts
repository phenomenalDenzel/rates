...
describe('Authentication reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMER_ACCOUNT_PENDING and FETCH_CUSTOMER_ACCOUNT_FULFILLED actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_CUSTOMER_ACCOUNT),
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_CUSTOMER_ACCOUNT),
    ...
    it('dispatches LOGIN, GET_SESSION, FETCH_CUSTOMER_ACCOUNT and SET_LOCALE success and request actions', async () => {
