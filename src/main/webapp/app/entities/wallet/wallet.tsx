  ...
  return (
    <div>
      <h2 id="wallet-heading">
        <Translate contentKey="ratesApp.wallet.home.title">Wallets</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="ratesApp.wallet.home.createLabel">Create new Wallet</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('ratesApp.wallet.home.search')}
                />
        ...
        {walletList && walletList.length > 0 ? (
            ...
            <tbody>
              {walletList.map((wallet, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{wallet.customerId ? <Link to={`customer/${wallet.customerId}`}>{wallet.customerId}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ratesApp.wallet.home.notFound">No Wallets found</Translate>
            </div>
          )
        )}
      </div>
