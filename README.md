...
This project requires an instance of Elasticsearch. The quickest way to get a running instance is via the below docker command.
...
### PWA Support (Not Required for dev env)
...
To build the final jar and optimize the rates application for production, run:
